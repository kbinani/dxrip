...
public:
    ...
    void PartitionDataset(ClassifierDataset<LearnerInput> &OutputSet0, ClassifierDataset<LearnerInput> &OutputSet1, double Set0ToSet1Ratio) const
    {
        ...
        for(UINT Index = 0; Index < _Entries.Length(); Index++)
        {
            ...
            {
                OutputSet0._Entries.PushEnd(_Entries[Index]);
            }
            else
            {
                OutputSet1._Entries.PushEnd(_Entries[Index]);
            }
        }
    }
